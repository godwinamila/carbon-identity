...
public class IdPManagementUtil {
    ...
    public static int getRememberMeTimeout(String tenantDomain) {
        return IdPManagementUtil.getTimeoutProperty(IdentityApplicationConstants.REMEMBER_ME_TIME_OUT, tenantDomain,
                Integer.parseInt(IdentityApplicationConstants.REMEMBER_ME_TIME_OUT_DEFAULT));
    }
