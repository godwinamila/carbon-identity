...
import org.wso2.carbon.identity.application.common.model.xsd.InboundApplicationAuthenticatorConfig;
...
public class ApplicationManagementServiceClient {
	 ...
	 * @throws AxisFault
	 */
	public ApplicationManagementServiceClient(String cookie, String backendServerURL, ConfigurationContext configCtx)
			throws AxisFault {
	 ...
	 * @throws AxisFault
	 */
	public Map<String, InboundApplicationAuthenticatorConfig> getAllInboundApplicationAuthenticators()
			throws AxisFault {

		Map<String, InboundApplicationAuthenticatorConfig> configMap = new HashMap<String, InboundApplicationAuthenticatorConfig>();
		try {
			InboundApplicationAuthenticatorConfig[] inboundAuthenticatorConfigs = stub
					.getAllInboundApplicationAuthenticators();
			if (inboundAuthenticatorConfigs != null && inboundAuthenticatorConfigs.length > 0) {
				for (InboundApplicationAuthenticatorConfig config : inboundAuthenticatorConfigs) {
	...
	private void handleException(Exception e) throws AxisFault {
		...
		if (e instanceof IdentityApplicationManagementServiceIdentityApplicationManagementException) {
			IdentityApplicationManagementServiceIdentityApplicationManagementException exception = (IdentityApplicationManagementServiceIdentityApplicationManagementException) e;
